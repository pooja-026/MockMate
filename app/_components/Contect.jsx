      ...
      <div className="mt-8">
        <form onSubmit={onSubmit} className="max-w-xl mx-auto">
          <input
            ...
            className="w-full px-4 py-2 mb-4 text-lg border border-gray-400 rounded-lg"
          />
          <input
            type="email"
          ...
          <button
            type="submit"
            className="px-6 py-2 text-lg font-semibold bg-gray-800 text-white rounded-lg shadow-lg hover:bg-gray-600"
          >
            {loading ? (
